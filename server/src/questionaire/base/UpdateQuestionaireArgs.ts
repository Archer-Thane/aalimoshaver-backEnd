...
@ArgsType()
class UpdateQuestionaireArgs {
  @Field(() => QuestionaireWhereUniqueInput, { nullable: false })
  where!: QuestionaireWhereUniqueInput;
  @Field(() => QuestionaireUpdateInput, { nullable: false })
  data!: QuestionaireUpdateInput;
}

export { UpdateQuestionaireArgs };
