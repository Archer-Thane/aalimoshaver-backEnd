...
export class PsychotherapistServiceBase {
  ...
  async findCheckoutPayments(
    parentId: string,
    args: Prisma.CheckoutPaymentFindManyArgs
  ): Promise<CheckoutPayment[]> {
    return this.prisma.psychotherapist
      .findUnique({
        where: { id: parentId },
      })
      .checkoutPayments(args);
  }
  ...
  async findPsychoSchedules(
    parentId: string,
    args: Prisma.PsychoScheduleFindManyArgs
  ): Promise<PsychoSchedule[]> {
    return this.prisma.psychotherapist
      .findUnique({
        where: { id: parentId },
      })
      .psychoSchedules(args);
  }
  ...
  async findWaitingLists(
    parentId: string,
    args: Prisma.WaitingListFindManyArgs
  ): Promise<WaitingList[]> {
    return this.prisma.psychotherapist
      .findUnique({
        where: { id: parentId },
