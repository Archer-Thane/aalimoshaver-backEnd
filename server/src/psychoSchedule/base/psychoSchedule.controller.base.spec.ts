...
describe("PsychoSchedule", () => {
  ...
  test("POST /psychoSchedules", async () => {
    await request(app.getHttpServer())
      .post("/psychoSchedules")
      .send(CREATE_INPUT)
  ...
  test("GET /psychoSchedules", async () => {
    await request(app.getHttpServer())
      .get("/psychoSchedules")
  ...
  test("GET /psychoSchedules/:id non existing", async () => {
    await request(app.getHttpServer())
      .get(`${"/psychoSchedules"}/${nonExistingId}`)
  ...
  test("GET /psychoSchedules/:id existing", async () => {
    await request(app.getHttpServer())
      .get(`${"/psychoSchedules"}/${existingId}`)
      .expect(HttpStatus.OK)
      .expect({
        ...FIND_ONE_RESULT,
