...
@InputType()
class PsychoScheduleUpdateInput {
  @ApiProperty({
    required: false,
  })
  @IsDate()
  ...
  @ApiProperty({
    required: false,
    type: () => SessionUpdateManyWithoutPsychoSchedulesInput,
  })
  @ValidateNested()
  @Type(() => SessionUpdateManyWithoutPsychoSchedulesInput)
  @IsOptional()
  @Field(() => SessionUpdateManyWithoutPsychoSchedulesInput, {
    nullable: true,
  })
  sessions?: SessionUpdateManyWithoutPsychoSchedulesInput;
}
export { PsychoScheduleUpdateInput };
