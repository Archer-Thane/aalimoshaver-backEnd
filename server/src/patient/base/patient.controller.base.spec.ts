...
const CREATE_INPUT = {
  ...
  totalSessionsLength: "exampleTotalSessionsLength",
  updatedAt: new Date(),
};
const CREATE_RESULT = {
  createdAt: new Date(),
  ...
  test("POST /patients", async () => {
    await request(app.getHttpServer())
      ...
      .expect({
        ...
        lastSessionTime: CREATE_RESULT.lastSessionTime.toISOString(),
      ...
      .expect([
        {
          ...
          lastSessionTime: FIND_MANY_RESULT[0].lastSessionTime.toISOString(),
  ...
  test("GET /patients/:id existing", async () => {
    await request(app.getHttpServer())
      ...
      .expect({
        ...
        lastSessionTime: FIND_ONE_RESULT.lastSessionTime.toISOString(),
